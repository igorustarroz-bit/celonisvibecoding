  ...
  function start() {
    ...
    const SPEC = [
      ...
      ["Lens", [
        ...
        ["lensChamfer", "Bevel on the top edge (0 = sharp)", 0, 0.12, 0.002, "lens"],
        ["lensCrease", "Hard edge at the corners", [0, 1], 0, 0, "lens"],
        ["lensSegments", "Lathe segments around", [90, 180, 360], 0, 0, "lens"],
        ["lensRings", "Rings across the underside", 8, 64, 2, "lens"],
      ...
      ["Scroll stages", [
        ["entryZoom", "Arrival: how many times bigger it starts", 1, 6, 0.1],
        ["entryRise", "Arrival: how far below it starts", 0, 6, 0.1],
        ["entryLen", "Arrival: how long it takes to settle", 0.1, 1, 0.05],
        ["scrollIn", "Arrival length (box heights)", 0.2, 4, 0.1],
        ["scrollHold", "Hold length (box heights)", 0, 4, 0.1],
        ["exitTurnFrom", "Exit: when the turn back starts", 0, 0.8, 0.05],
